...
# -*- coding: utf-8 -*-
"""
from https://github.com/ebatty/behavenet/blob/develop/behavenet/fitting/ae_model_architecture_generator.py
"""

import copy
import commentjson
import numpy as np
from drvae.model.aes import AE # Dan: my change, these files are saved in the same folder.
